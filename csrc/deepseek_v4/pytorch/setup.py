...
setup(
    ...
    ext_modules=[CppExtension(
        ...
        ["hpu_dsv4_sparse_attn_pt2.cpp", "hpu_dsv4_mhc_pt2.cpp", "hpu_dsv4_router_pt2.cpp",
         ...
         "hpu_dsv41_mxfp4_mme_pt2.cpp", "hpu_dsv41_quant_roundtrip_pt2.cpp", "hpu_dsv41_selected_kv_pt2.cpp", "hpu_dsv41_control_gemv_pt2.cpp", "hpu_dsv41_fp8_operands_pt2.cpp", "hpu_dsv41_swa_pack_pt2.cpp", "hpu_dsv41_fp4_pack_pt2.cpp", "hpu_dsv41_csa2_prep_pt2.cpp", "hpu_dsv41_decoded_kv_pt2.cpp"],
