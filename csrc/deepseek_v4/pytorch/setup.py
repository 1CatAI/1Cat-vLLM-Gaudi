    ...
    ext_modules=[
        CppExtension(
            ...
            [
                ...
                "hpu_dsv41_prefill_permuted_pt2.cpp",
                "hpu_dsv41_quant_roundtrip_pt2.cpp", "hpu_dsv41_selected_kv_pt2.cpp",
                ...
                "hpu_dsv41_compressor_pair_pt2.cpp", "hpu_dsv41_decoded_kv_pt2.cpp", "hpu_dsv41_fp4_pack_pt2.cpp",
                "hpu_dsv41_fp8_operands_pt2.cpp", "hpu_dsv41_dense_fp8_pt2.cpp", "hpu_dsv41_q_projection_rope_pt2.cpp",
                "hpu_dsv41_prefill_q_projection_pt2.cpp", "hpu_dsv41_prefill_index_pt2.cpp",
                "hpu_dsv41_prefill_topk_pt2.cpp",
                "hpu_dsv41_mla_mme_pt2.cpp", "hpu_dsv41_router_top6_pt2.cpp", "hpu_dsv41_router_logits_top6_pt2.cpp",
                "hpu_dsv41_swa_pack_pt2.cpp", "hpu_dsv41_woa_fp8_pt2.cpp", "hpu_dsv41_bf16_linear_f32_pt2.cpp",
                "hpu_dsv41_mhc_gates_pt2.cpp", "hpu_dsv41_index_pt2.cpp", "hpu_dsv41_index_keys_pt2.cpp",
                "hpu_dsv41_prefill_route_pt2.cpp", "hpu_dsv41_prefill_mhc_pt2.cpp",
                "hpu_dsv41_candidate_gather_pt2.cpp", "hpu_dsv41_prefill_flash_pt2.cpp",
                "hpu_dsv41_prefill_sparse_mla_pt2.cpp", "hpu_dsv41_prefill_paged_index_pt2.cpp",
                "hpu_dsv41_prefill_main_decode_pt2.cpp"
            ],
