...
def grouped_fp8_w13_terms(high, high_scale, low, low_scale, expert_ids, q, scales, channel, lookup, packed=False):
...
def run_grouped_prefill(value, ids, routing, q13, q2, s13, s2, lookup, normal_scales, channel13=None, channel2=None):
