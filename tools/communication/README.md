...
The original fused-boundary extension depends on the Bridge patch in
...
## Native decoder joint replay

The fixed-input and native joint replay candidate additionally requires the
[pinned Bridge, Synapse and HCL patches](patches/native-runtime/README.md).
This research path remains default-off and is not fully quality or performance
qualified. Build and validate it as a separate runtime installation.
